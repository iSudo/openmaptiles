    ...
    WITH important_city_point AS (
        ...
        FROM osm_city_point AS osm
            ...
            (
                ...
                lower(osm.name) IN (lower(ne.name), lower(ne.namealt), lower(ne.meganame), lower(ne.nameascii)) OR
                lower(osm.name_en) IN (lower(ne.name), lower(ne.namealt), lower(ne.meganame), lower(ne.nameascii)) OR
